						...
						<div class="card-body">
							...
							<form action="" method="post">
								...
								<div class="mb-3">
									...
									<input type="text" name="Nama_KK_Pindah" class="form-control form-control-sm" id="Nama_KK_Pindah" readonly>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3 ">
											...
											<input type="date" name="Tanggal_Lahir_KK_Pindah" class="form-control form-control-sm" id="Tanggal_Lahir_KK_Pindah" readonly>
										</div>
									</div>
									<!-- RW -->
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Umur_KK_Pindah" class="form-control form-control-sm" id="Umur_KK_Pindah" readonly>
								...
								<div class="mb-3">
									...
									<input type="text" name="Nama_Istri_Pindah" class="form-control form-control-sm" id="Nama_Istri_Pindah" readonly>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3 ">
											...
											<input type="date" name="Tanggal_Lahir_Istri_Pindah" class="form-control form-control-sm" id="Tanggal_Lahir_Istri_Pindah" readonly>
										</div>
									</div>
									<!-- RW -->
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Umur_Istri_Pindah" class="form-control form-control-sm" id="Umur_Istri_Pindah" readonly>
