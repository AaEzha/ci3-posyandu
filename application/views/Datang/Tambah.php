  ...
  <div class="card">
    ...
    <div class="row row-cols-2 row-cols-md-3 g-4">
      ...
      <h5 class="card-title text-center"><strong>DATA DIRI SUAMI</strong></h5><hr class="mx-auto" width="40%">
        ...
        <input type="date" name="Tanggal_Lahir_KK" class="form-control form-control-sm" >
        </div>
        </div>
        <!-- RW -->
        <div class="col-md-6">
        ...
        <input type="text" name="Umur_KK" class="form-control form-control-sm" >
        <small  class="form-text text-danger"><?= form_error('Umur_KK') ?></small>
          ...
          <input type="text" name="Nama_Istri" class="form-control form-control-sm">
        ...
        <input type="date" name="Tanggal_Lahir_Istri" class="form-control form-control-sm" >
        </div>
        </div>
        <!-- RW -->
        <div class="col-md-6">
