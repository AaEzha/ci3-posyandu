...
<div class="container"><br>
	<h2 class="text-center"> Form Penambahan Data Penduduk</h2>
						...
						<div class="card-body">
							...
							<form action="" method="post">
								...
								<div class="mb-3">
									...
									<input type="text" name="No_KK" class="form-control form-control-sm" id="No_KK">
								...
								<div class="mb-3">
									...
									<input type="text" name="Tempat_Lahir" class="form-control form-control-sm" id="Tempat_Lahir">
									<small class="form-text text-danger"><?= form_error('Tempat_Lahir') ?></small>
								</div>
								<div class="mb-3">
									<label for="Tanggal_Lahir">Tanggal Lahir</label>
									<input type="date" name="Tanggal_Lahir" class="form-control form-control-sm" id="Tanggal_Lahir">
					...
					<div class="card h-100">
						<div class="card-body">
							...
							<div class="mb-3">
								...
								<input type="text" name="Alamat" class="form-control form-control-sm" id="Alamat" value="Jl. Orion">
							</div>
							<!-- RT -->
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="mb-3">
										...
										<input type="text" name="Rw" class="form-control form-control-sm" id="Rw" value="13">
							...
							<div class="mb-3">
								...
								<input type="text" name="Desa" class="form-control form-control-sm" id="Desa" value="Kertajaya">
							</div>
							<!-- Kecamatan -->
							<div class="mb-3">
								<label for="Kecamatan">Kecamatan</label>
								<input type="text" name="Kecamatan" class="form-control form-control-sm" id="Kecamatan" value="Padalarang">
							</div>
							<!-- Kabupaten -->
							<div class="mb-3">
								<label for="Kabupaten">Kabupaten</label>
								<input type="text" name="Kabupaten" class="form-control form-control-sm" id="Kabupaten" value="Bandung Barat">
							</div>
							<!-- Provinsi -->
							<div class="mb-3">
								<label for="Provinsi">Provinsi</label>
								<input type="text" name="Provinsi" class="form-control form-control-sm" id="Provinsi" value="Jawa Barat">
							</div>
					...
					<div class="card h-100">
						<div class="card-body">
							...
							<div class="mb-3">
								...
								<input type="text" name="Nama_Ibu" class="form-control form-control-sm" id="Nama_Ibu">
								<small class="form-text text-danger"><?= form_error('Nama_Ibu') ?></small>
							</div>
							<div class="mb-3">
								<label for="Nama_Ayah">Nama Ayah</label>
								<input type="text" name="Nama_Ayah" class="form-control form-control-sm" id="Nama_Ayah">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mb-3">
										...
										<input type="text" name="Pekerjaan" class="form-control form-control-sm" id="Pekerjaan">
								...
								<div class="col-md-6">
									<div class="mb-3">
										...
										<input type="text" name="KWN" class="form-control form-control-sm" id="KWN" value="WNI">
