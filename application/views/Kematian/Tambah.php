					...
					<div class="card h-100">
						<div class="card-body">
							...
							<form action="" method="post">
								<input type="hidden" class="form-control form-control-sm" name="Id_Kematian" value="KMT-<?php echo sprintf("%05s", $Id_Kematian) ?>" readonly>
								<!-- Field -->
								<!-- Nama Suami -->
								<div class="mb-3">
									<label for="Nik">NIK Yang Meninggal</label>
									<input type="text" name="Nik_Meninggal" id="Nik_Meninggal" class="form-control form-control-sm" onchange="datanya(this.value)">
									<small class="form-text text-danger"><?= form_error('Nik_Meninggal') ?></small>
								</div>
								<div class="mb-3">
									<label for="Nama">Nama Yang Meninggal</label>
									<input type="text" name="Nama_Meninggal" id="Nama_Meninggal" class="form-control form-control-sm" readonly>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3 ">
											...
											<input type="date" class="form-control form-control-sm" name="Tanggal_Lahir" id="Tanggal_Lahir" readonly>
										</div>
									</div>
									<!-- RW -->
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Umur" id="Umur" class="form-control form-control-sm" readonly>
								...
								<div class="mb-3">
									...
									<input type="text" name="Jenis_Kelamin" id="Jenis_Kelamin" class="form-control form-control-sm" readonly>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3 ">
											...
											<input type="date" class="form-control form-control-sm" name="Tanggal_Meninggal">
										</div>
									</div>
									<!-- RW -->
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Penyebab" class="form-control form-control-sm">
