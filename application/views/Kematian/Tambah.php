...
<hr class="mx-auto" width="35%"><BR>
  ...
  <div class="card">
    ...
    <div class="row row-cols-2 row-cols-md-2 g-4">
      ...
      <div class="card-body">
      <h5 class="card-title text-center"><strong>DATA YANG MENINGGAL</strong></h5><hr class="mx-auto" width="40%">
        <!-- Form -->
        ...
        <input type="hidden" class="form-control form-control-sm"  name="Id_Kematian" value="KMT-<?php echo sprintf("%05s", $Id_Kematian) ?>" readonly>
          ...
          <input type="text" name="Nama_Meninggal" class="form-control form-control-sm" >
        ...
        <input type="text" name="Umur" class="form-control form-control-sm">
