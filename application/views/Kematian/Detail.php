								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3 ">
											...
											<input type="date" class="form-control form-control-sm" name="Tanggal_Meninggal"  value="<?=$data->Tanggal_Meninggal;?>" readonly>
										</div>
									</div>
									<!-- RW -->
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Penyebab" class="form-control form-control-sm"  value="<?=$data->Penyebab;?>" readonly>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mb-3 ">
										...
										<select class="form-select form-select-sm" id="Rt" name="Rt" disabled>
