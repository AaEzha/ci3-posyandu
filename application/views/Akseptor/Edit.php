...
<div class="container"><br>
	<h2 class="text-center"> Form Peubahan Data Akseptor</h2>
		...
		<div class="card-body">
			...
			<div class="row row-cols-2 row-cols-md-3 g-4">
					...
					<div class="card h-100">
						<div class="card-body">
							...
							<form action="" method="post">
								<input type="hidden" class="form-control form-control-sm" id="Id_Akseptor" name="id" value="<?= $Akseptor['Id_Akseptor'] ?>" readonly>
								<!-- Field -->
								<!-- Nama Suami -->
								<div class="mb-3">
								...
								<div class="mb-3">
									...
									<input type="text" name="Nama_Suami" class="form-control form-control-sm" id="Nama_Suami" value="<?= $Akseptor['Nama_Suami'] ?>" readonly>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3 ">
											...
											<input type="date" name="Tanggal_Lahir_Suami" id="Tanggal_Lahir_Suami" class="form-control form-control-sm" value="<?= $Akseptor['Tanggal_Lahir_Suami'] ?>" readonly>
										</div>
									</div>
									<!-- Tempat Pelkon -->
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Umur_Suami" id="Umur_Suami" class="form-control form-control-sm" value="<?= $Akseptor['Umur_Suami'] ?>" readonly>
								...
								<div class="mb-3">
									...
									<input type="text" name="Nama_Istri" class="form-control form-control-sm" id="Nama_Istri" value="<?= $Akseptor['Nama_Istri'] ?>" readonly>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3 ">
											...
											<input type="date" name="Tanggal_Lahir_Istri" id="Tanggal_Lahir_Istri" class="form-control form-control-sm" value="<?= $Akseptor['Tanggal_Lahir_Istri'] ?>" readonly>
										</div>
									</div>
									<!-- Tempat Pelkon -->
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="Umur_Istri" id="Umur_Istri" class="form-control form-control-sm" value="<?= $Akseptor['Umur_Istri'] ?>" readonly>
				...
				<div class="col">
					<div class="card h-100">
						<div class="card-body">
							<h5 class="card-title text-center"><strong>DATA AKSEPTOR (KB)</strong></h5>
							<hr class="mx-auto" width="40%">
							<!-- Data Akseptor -->
							<!-- Jumlah Anak Lk -->
							<div class="row">
