						...
						<div class="card-body">
							...
							<form action="" method="post">
								...
								<div class="mb-3">
									...
									<input type="text" name="Nama_Suami" class="form-control form-control-sm" id="Nama_Suami" readonly>
									<small class="form-text text-danger"><?= form_error('Nama_Suami') ?></small>
								</div>
								<!-- Tanggal Lahir Suami -->
								<div class="mb-3">
									<label for="Tanggal_Lahir_Suami">Tanggal Lahir</label>
									<input type="date" name="Tanggal_Lahir_Suami" class="form-control form-control-sm" id="Tanggal_Lahir_Suami" readonly>
								</div><br>
								<hr>
								<!-- Tanggal Lahir Suami -->
								...
								<div class="mb-3">
									...
									<input type="text" name="Nama_Istri" class="form-control form-control-sm" id="Nama_Istri" readonly>
									<small class="form-text text-danger"><?= form_error('Nama_Istri') ?></small>
								</div>
								<!-- Tanggal Lahir Istri -->
								<div class="mb-3">
									<label for="Tanggal_Lahir_Istri">Tanggal Lahir</label>
									<input type="date" name="Tanggal_Lahir_Istri" class="form-control form-control-sm" id="Tanggal_Lahir_Istri" readonly>
								</div>
								<!-- Tanggal Lahir Istri -->
