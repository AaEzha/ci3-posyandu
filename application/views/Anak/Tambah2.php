...
<!-- Text -->
<h2 class="text-center"> Tambah Data Anak dan Balita</h2><hr class="mx-auto" width="50%"><BR>
  ...
  <div class="col">
    <div class="card h-100">
      <div class="card-body">
        ...
        <input type="text" name="NIK" class="form-control" id="NIK" value="-" readonly>
        </div>
        ...
        <input type="text" name="Status_Warga" class="form-control" id="Status_Warga" value="Warga Tamu" readonly>
        </div>
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="Rt" class="form-control" id="Rt" placeholder="Contoh: Rt.001 (Angka Saja)" >
        ...
        <input type="text" name="Rw" class="form-control" id="Rw" placeholder="Contoh: Rw.022 (Angka Saja)" >
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
          ...
          <button type="submit" style="background-color:#5894C6" name="tambah2" class="btn btn-primary">Simpan Data </button>
</div>
      </div>
    </div>
  </div>
